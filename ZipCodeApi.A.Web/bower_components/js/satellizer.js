    ...
    .provider('$auth', ['satellizer.config', function(config) {
      ...
      this.$get = [
        ...
        function($q, shared, local, oauth) {
          ...
          $auth.login = function(user, options , redirect) {
              return local.login(user, options, redirect);
          };
